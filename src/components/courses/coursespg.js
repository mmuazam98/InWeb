...
import "./coursespg.css";
const Course = () => {
  return (
    <React.Fragment>
      <Nav />{" "}
      <div className="shadow p-3 mb-5 bg-body rounded">
        <h1 className="text-center text-success text-capitalize">COURSES SCHOOL OF COMPUTING</h1>
      </div>
            ...
            <div className="col">
              <div className="card mb-5">
                ...
                <div className="card-body">
                  ...
                  <div className="btn btn-success">View Contents</div>
                </div>
              </div>
            </div>
            <div className="col">

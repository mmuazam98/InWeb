...
const Home = () => {
    return (
        ...
        <Link to={'/Blogs'} className="nav-link"><img src = { require('../../assets/blogs.png') } className = "images__banner grow" alt="blogs" /></Link>
        ...
        <div className = "col-xs-12 col-sm-12 col-md-4" >
        <Link to={'/Courses'} className="nav-link"><img src = { require('../../assets/courses.png') } className = "images__banner grow" alt="courses" /></Link>
        ...
        <div className = "col-xs-12 col-sm-12 col-md-4" >
        <a href="https://collegemadesimpler.herokuapp.com" className="nav-link"><img src = { require('../../assets/poll.png') }className = "images__banner grow" alt="polling" /></a>
        <a href="https://collegemadesimpler.herokuapp.com" className="nav-link"><h3 className = "course_heading lastques underline" > Polling </h3> </a>
